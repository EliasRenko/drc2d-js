...
{
	/**
	 * The bottom (y + height) value of the `Rectangle`.
	 */
	public var bottom(get, set):Float;

	/**
	 * The bottom right (x + width, y + height) value of the `Rectangle`.
	 */
	...
	/**
	 * The left (x) value of the `Rectangle`.
	 */
	public var left(get, set):Float;

	/**
	 * The right (x + width) value of the `Rectangle`.
	 */
	...
	**/
	...
	/**
	 * The top (y) value of the `Rectangle`.
	 */
	public var top(get, set):Float;

	/**
	 * The top-left (x, y) value of the `Rectangle`.
	 */
	...
	**/
	...
	/**
	 * Returns a new rectangle with the area where the current `Rectangle` and another `Rectangle` instance overlap.
	 * If they do not overlap, the returned `Rectangle` will be empty.
	 * 
